...
const PatientVitalsAndMetrics = (props) => {
            ...
            <div className="card-header">
              <div className="row">
                <div className="col-md-6">
                  ...
                  <span>{'Métricas y signos vitales del paciente.'}</span>
                </div>
                <div className="col-md-6">
                  ...
                  noDataComponent={
                    <div className="col-md-12 text-center m-50">
                      ...
                      <span className="txt-info">
                        El paciente aún no tiene métricas ni signos vitales
                        cargados...
                      </span>
                    </div>
                  }
...
export default PatientVitalsAndMetrics;
