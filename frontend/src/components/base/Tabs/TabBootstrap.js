...
import {BasicTabs,TabsBottomLeftAlign,TabsWithIcon,TabsRightAlign,TabsVertical,PillTabs,PillTabsWithIcon,PillDarkColor,PrimaryColor,SecondaryColor,SuccessColor,InfoColor,WarningColor,DangerColor,Homes,Action,Contact,Profile,Messages,Settings,AnotherAction,Add,SomethingElseHere,SeparatedLink} from '../../../constant'
...
const TabBootstrap = (props) => {
  ...
  const toggle = () => setDropdownOpen(prevState => !prevState);
    ...
    return (
      <Fragment>
        <Breadcrumb parent="Base / Tabs" title="Bootstrap Tabs"/>
              ...
              <Col sm="12" xl="6 xl-100" >
                <Card>
                  ...
                  <CardBody>
                     <Nav tabs>
                       <NavItem>
                           <NavLink href="#javascript"  className={BasicTab === '1' ? 'active' : ''} onClick={() => setBasicTab('1')}>{Homes}</NavLink>
                       </NavItem>
                ...
                <Card>
                  ...
                  <CardBody>
                    ...
                    <Nav className="nav nav-tabs nav-bottom" >
                      <NavItem>
                          <NavLink href="#javascript"  className={BottomTab === '1' ? 'active' : ''} onClick={() => setBottomTab('1')}><i className="icofont icofont-ui-home"></i>{Homes}</NavLink>
                      </NavItem>
                      <NavItem >
             ...
             <Col sm="12" xl="6 xl-100">
                <Card>
                  ...
                  <CardBody>
                     <Nav tabs>
                       <NavItem>
                           <NavLink href="#javascript"  className={IconWithTab === '1' ? 'active' : ''} onClick={() => setIconWithTab('1')}><i className="icofont icofont-ui-home"></i>{Homes}</NavLink>
                       </NavItem>
                       <NavItem>
                ...
                <Card>
                  ...
                  <CardBody>
                    <Nav className="nav nav-tabs nav-right" >
                      <NavItem>
                          <NavLink href="#javascript"  className={RightTab === '1' ? 'active' : ''} onClick={() => setRightTab('1')}><i className="icofont icofont-ui-home"></i>{Homes}</NavLink>
                      </NavItem>
                      <NavItem >
                    ...
                    <Row>
                      <Col sm="3" xs="12">
                        <Nav className="nav flex-column nav-pills">
                          <NavItem>
                            <NavLink href="#javascript"  className={VerticleTab === '1' ? 'active' : ''} onClick={() => setVerticleTab('1')}>{Homes}</NavLink>
                          </NavItem>
                          <NavItem>
                ...
                <Card>
                  ...
                  <CardBody>
                    <Nav className="nav-pills">
                      <NavItem>
                          <NavLink href="#javascript"  className={pillTab === '1' ? 'active' : ''} onClick={() => setpillTab('1')}>{Homes}</NavLink>
                      </NavItem>
                      <NavItem >
              ...
              <Col sm="12" xl="6 xl-100">
                <Card className="height-equal">
                  ...
                  <CardBody>
                    <Nav className="nav-pills">
                      <NavItem>
                          <NavLink href="#javascript"  className={pillWithIconTab === '1' ? 'active' : ''} onClick={() => setpillWithIconTab('1')}><i className="icofont icofont-ui-home"></i>{Homes}</NavLink>
                      </NavItem>
                      <NavItem >
                ...
                <Card className="height-equal">
                  ...
                  <CardBody>
                    <Nav className="nav-dark">
                      <NavItem>
                          <NavLink href="#javascript"  className={pillDarkTab === '1' ? 'active' : ''} onClick={() => setpillDarkTab('1')}><i className="icofont icofont-ui-home"></i>{Homes}</NavLink>
                      </NavItem>
                      <NavItem >
                ...
                <Card>
                  ...
                  <CardBody>
                     <Nav className="nav-primary" tabs>
                      <NavItem>
                          <NavLink href="#javascript"  className={primarycolorTab === '1' ? 'active' : ''} onClick={() => setprimarycolorTab('1')}><i className="icofont icofont-ui-home"></i>{Homes}</NavLink>
                      </NavItem>
                      <NavItem >
                ...
                <Card>
                  ...
                  <CardBody>
                    <Nav className="nav-secondary nav-pills" >
                      <NavItem>
                          <NavLink href="#javascript"  className={secondaryTab === '1' ? 'active' : ''} onClick={() => setsecondaryTab('1')}><i className="icofont icofont-ui-home"></i>{Homes}</NavLink>
                      </NavItem>
                      <NavItem >
              ...
              <Col sm="12" xl="6 xl-100">
                <Card>
                  ...
                  <Nav className="nav-success nav-pills" >
                      <NavItem>
                          <NavLink href="#javascript"  className={successTab === '1' ? 'active' : ''} onClick={() => setsuccessTab('1')}><i className="icofont icofont-ui-home"></i>{Homes}</NavLink>
                      </NavItem>
                      <NavItem >
              ...
              <Col sm="12" xl="6 xl-100">
                <Card>
                  ...
                  <Nav className="nav-info nav-pills" >
                      <NavItem>
                          <NavLink href="#javascript"  className={infoTab === '1' ? 'active' : ''} onClick={() => setinfoTab('1')}><i className="icofont icofont-ui-home"></i>{Homes}</NavLink>
                      </NavItem>
                      <NavItem >
              ...
              <Col sm="12" xl="6 xl-100">
                <Card>
                  ...
                  <Nav className="nav-warning nav-pills" >
                      <NavItem>
                          <NavLink href="#javascript"  className={warningTab === '1' ? 'active' : ''} onClick={() => setwarningTab('1')}><i className="icofont icofont-ui-home"></i>{Homes}</NavLink>
                      </NavItem>
                      <NavItem >
              ...
              <Col sm="12" xl="6 xl-100">
                <Card>
                  ...
                  <Nav className="nav-danger nav-pills" >
                      <NavItem>
                          <NavLink href="#javascript"  className={dangerTab === '1' ? 'active' : ''} onClick={() => setdangerTab('1')}><i className="icofont icofont-ui-home"></i>{Homes}</NavLink>
                      </NavItem>
                      <NavItem >
